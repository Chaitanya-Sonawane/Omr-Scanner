...
def detect_bubbles(img_path, debug_out=None):
    ...
    results = {}
    debug_img = orig.copy()
    # Sample inner ~55% of bubble radius to reduce bleed from adjacent cells
    ...
    # Adaptive blank baseline: most bubbles are unmarked, so the median
    # brightness represents blank paper. Filled bubbles are much darker.
